import { s3 } from '../../src/data';
import { ReceivedEvent } from '../../src/event';
describe('model', function () {
  describe('ReceivedEvent', () => {
    it('should parse a basic event', async () => {
      ...
      const receivedEvent = new ReceivedEvent<s3.CreateBucket>(event);
      receivedEvent.detail.requestParameters.Bucket;
      receivedEvent.detail.requestParameters.GrantFullControl;
